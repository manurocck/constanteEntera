...
/* Line 1455 of yacc.c  */
#line 22 "calculadoraV2.y"
    { char hex[20]; decimalAhexa(hex,(yyvsp[(1) - (2)])); printf ("\t Resultado en decimal : %d\n", (yyvsp[(1) - (2)])); 
